...
export const connectAccountingProvider = base44.functions['accounting/connectProvider'];

export const completeAccountingConnection = base44.functions['accounting/completeConnection'];

export const connectBank = base44.functions['banking/connectBank'];

export const autoMatchReconciliation = base44.functions['reconciliation/autoMatch'];

export const connectProvider = connectAccountingProvider;

export const autoMatch = autoMatchReconciliation;
