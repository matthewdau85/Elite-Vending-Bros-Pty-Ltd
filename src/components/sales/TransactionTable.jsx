...
export default function TransactionTable({ sales, machines, locations, products, isLoading }) {
  ...
  const filteredSales = sales.filter(sale => {
    ...
    return (
      ...
      machineInfo.machine_id?.toLowerCase().includes(searchLower) ||
      machineInfo.location_name?.toLowerCase().includes(searchLower) ||
                      ...
                      return (
                        <TableRow key={sale.id} className="hover:bg-slate-50">
                          ...
                          <TableCell className="text-center">
                            <Badge className={paymentColors[sale.payment_method] || "bg-gray-100 text-gray-800"}>
                              {sale.payment_method}
                            </Badge>
                          </TableCell>
                          <TableCell className="text-center">
