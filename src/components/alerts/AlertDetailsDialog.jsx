...
export default function AlertDetailsDialog({ alert, machine, location, open, onClose, onUpdate }) {
      ...
      <DialogContent className="max-w-2xl">
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-slate-600">
                      {format(new Date(alert.alert_datetime), "PPP p")}
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-slate-600">
                      Machine: <strong>{machine?.machine_id || alert.machine_id}</strong>
                    </span>
                  </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-slate-600">
                      Alert created - {format(new Date(alert.alert_datetime), "PPP p")}
                    </span>
                  </div>
        ...
        <DialogFooter className="gap-2">
          ...
          >
            ...
            {isUpdating ? "Deleting..." : "Delete Alert"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
