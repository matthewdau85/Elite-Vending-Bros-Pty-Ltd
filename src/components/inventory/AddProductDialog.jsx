...
export default function AddProductDialog({ open, onClose, onSubmit, suppliers, product }) {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button 
              type="submit" 
              disabled={isSubmitting || !formData.sku || !formData.name || !formData.base_cost || !formData.base_price}
